          ...
          <div className="space-y-8">
            ...
            <section className="relative overflow-hidden border border-white/10 bg-[#080A0F] p-6 shadow-xl">
              ...
              <div className="mt-4 border border-white/10 bg-[#050816] p-4 text-center">
                <div className="mx-auto flex h-20 w-20 items-center justify-center border-2 border-dashed border-[#00E5FF]/40 bg-black/40 text-[#00E5FF]">
                  <QrCode size={48} />
                </div>
                <div className="mt-3 font-mono text-xs font-bold uppercase tracking-wider text-white">
                  {profile?.fullName || user.name}
                </div>
                <div className="font-mono text-[10px] text-[#00E5FF]">
                ...
                <p className="mt-2 font-mono text-[8px] uppercase tracking-widest text-slate-500">
                  Present this gate pass at event venue check-in points
                </p>
              </div>
            </section>
          </div>
