  ...
  return (
    ...
    >
      <motion.div
        ...
        className="relative max-h-[85vh] w-full max-w-3xl overflow-y-auto border border-white/20 bg-[#080A0F] p-6 text-white shadow-[0_25px_80px_rgba(0,0,0,0.7)] sm:p-8"
      >
        {/* Technical corners */}
