...
> = {
  ...
  "6a9e49bc001a4ecd3542": {
    ...
    instructions: [
      ...
      "The problem statement will be revealed at the start, and the website must be developed within the given time.",
      "Plagiarism, copying, or using ready-made/purchased templates will result in disqualification.",
      "AI tools may only be used for learning, debugging, and understanding concepts, unless organizers specify otherwise.",
    ],
  },
  "6a9e4a74000b89971a9f": {
    ...
    instructions: [
      ...
      "Confidential files will be provided in printed form in four parts each containing pointer to next part.",
    ],
  },
  "6a9e4b2d0000cc64ad18": {
    ...
    instructions: [
      ...
      "Pitch deck is compulsory ,MVP is optional",
      "A maximum of 4 minutes will be provided for presenting pitch deck by each team.",
      "Registration will be taken through Yantrotsav Official Website only.",
      "Seats are limited so registration will be accepted on first come first serve basis and it will be closed automatically once all seats are filled. ",
    ],
  },
  ...
  "6a9e4c730027321e366d": {
    ...
    instructions: [
      ...
      "Registration will be accepted only through official Yantrotsav Website",
      "Seats are limited so registration will be accepted on first come first serve basis and it will be closed automatically once all seats are filled. ",
    ],
  },
